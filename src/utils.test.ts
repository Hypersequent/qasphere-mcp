...
describe('JSONStringify', () => {
    ...
    it('should rename only specified top-level keys when using string values', () => {
        ...
        const expected = {
            ...
            d: [{ a: 50, x: 100 }, { b: 60, a: 70 }], // nested a/b untouched
            e: null,
            f: [1, 2, 3],
    ...
    it('should rename nested keys using nested rename map objects', () => {
        const renameMap: RenameMap = { c: { a: 'z', d: { a: 'k' } }, g: {a: 'g_new'} };
        const expected = {
            a: 1,
            b: 2,
            c: { z: 11, b: 22, d: { k: 111 } }, // c.a renamed to z, c.d.a renamed to k
            d: [{ a: 50, x: 100 }, { b: 60, a: 70 }], // d array untouched
            e: null,
            f: [1, 2, 3],
